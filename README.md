# The Persuasion Incline — interactive companion
...
route (the *persuasion incline*) in the browser, then steps through the route
one concession at a time.

This is a deployment mirror; the source of record lives in the authors'
research repository.
